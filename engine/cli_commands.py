...
COMMAND_SPECS: tuple[CliCommandSpec, ...] = (
    ...
    CliCommandSpec(
        ...
        "Validate ticket contracts",
        "ai tickets validate",
        aliases=("/tickets-validate",),
    ),
    CliCommandSpec(
        "tickets list",
        "tickets list",
        "List tickets with status and metadata",
        "List all tickets",
        "ai tickets list",
        aliases=("/tickets-list", "/tickets"),
    ),
    CliCommandSpec(
        "precheck-collisions",
        "precheck-collisions",
        "Run file collision checker on active tickets",
        "Check file collisions",
        "ai precheck-collisions",
        aliases=("/precheck-collisions",),
    ),
    CliCommandSpec(
        "stage-review-inputs",
        "stage-review-inputs [--batch_id ID]",
        "Stage worker outputs for review",
        "Stage review inputs",
        "ai stage-review-inputs",
        aliases=("/stage-review-inputs",),
    ),
    CliCommandSpec(
        "batch-close",
        "batch-close [--execute]",
        "Post-batch canonical sync gate (dry-run by default)",
    ...
    CliCommandSpec(
        "mode",
        "mode [--mode plan|execution]",
        "Show or set orchestration mode (plan/execution)",
    ...
    CliCommandSpec(
        "plan generate",
        "plan generate",
        "Generate plan outputs (DAG, batch plan, ownership matrix)",
        "Generate plan artifacts",
        "ai plan generate",
        aliases=("/plan-generate",),
    ),
    CliCommandSpec(
        "plan approve",
        "plan approve",
        "Approve plan and generate execution tickets",
        "Approve plan",
        "ai plan approve",
